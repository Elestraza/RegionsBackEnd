...
{
    public async Task<Result> SaveProduct(SettlementsBlank productBlank)
    {
    ...
    private async Task<DataResult<Product>> ValidateProductBlank(SettlementsBlank productBlank)
    {
    ...
    private async Task<DataResult<Guid?>> ValidateExistProduct(SettlementsBlank productBlank)
    {
    ...
    private DataResult<ProductCategory> ValidateProductCategory(SettlementsBlank productBlank)
    {
    ...
    private async Task<DataResult<String>> ValidateProductName(SettlementsBlank productBlank)
    {
    ...
    private DataResult<Decimal> ValidateProductPrice(SettlementsBlank productBlank)
    {
